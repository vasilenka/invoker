...
$bg-rose-100                : #FCE7DD;
```
![alt text](https://raw.githubusercontent.com/vasilenka/invoker/master/src/colors/amber-100.png "Rose 100 - #FCE7DD")
```scss
$bg-rose-200                : #FCE7DD;
```
![alt-text](https://raw.githubusercontent.com/vasilenka/invoker/master/src/colors/amber-200.png "Rose 200 - ")
![alt-text](https://raw.githubusercontent.com/vasilenka/invoker/master/src/colors/amber-300.png "Rose 200 - ")
